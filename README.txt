Copied from https://sourceforge.net/p/refind/code/ci/master/tree/

- Refind Docs: https://www.rodsbooks.com/refind/
- UEFI on ArchWiki: https://wiki.archlinux.org/title/Unified_Extensible_Firmware_Interface
